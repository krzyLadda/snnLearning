...
def run(task_id):
    ...
    version = 'batch'  # learning version
    ...
    if load:
        ...
        hmN = 20  # number of hidden neurons
...
hm_calls = list(range(1))  # [2, 3, 4]
filename = 'pwr_result_batch'  # name of file, where results will be saved
