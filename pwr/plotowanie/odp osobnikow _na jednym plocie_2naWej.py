...
filename = '16 pwr_result_online_in_minibatch_close_loop_2sNaWej_rate0.1_nets_answers_and_mse'
...
plt.figure(1)
plt.plot(learning_targets, 'b--', label='Reference trajectory', linewidth=1.0)
ax = plt.gca()
ax.set_ylabel('Average thermal power of the reactor $[W]$')
ax.set_xlabel('$t[s]$')
...
plt.figure(2)
ax = plt.gca()
plt.plot(test_targets_1, 'b--', label='Reference trajectory', linewidth=1.0)
ax.set_ylabel('Average thermal power of the reactor $[W]$')
ax.set_xlabel('$t[s]$')
ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.40), fancybox=True, shadow=True, ncol=3)
...
plt.figure(3)
ax = plt.gca()
plt.plot(test_targets_2, 'b--', label='Reference trajectory', linewidth=1.0)
ax.set_ylabel('Average thermal power of the reactor $[W]$')
ax.set_xlabel('$t[s]$')
ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.40), fancybox=True, shadow=True, ncol=3)
