...
filename = '14v2  pwr_result_online_in_minibatch_close_loop_2sNaWej_rate0.1_v2'
...
for i in range(10):
    ...
    if 'testowe1' in what_to_show:
        answer_ver1, temp_mse = plot_and_calc('testowy1.mat', config, net)
        ver1_odp.append(answer_ver1)
        mse_ver1.append(temp_mse)

    # %% plot odpowiedzi sieci testowe 2
    if 'testowe2' in what_to_show:
        answer_ver2, temp_mse = plot_and_calc('testowy2.mat', config, net)
        ver2_odp.append(answer_ver2)
        mse_ver2.append(temp_mse)
