...
import numpy as np
from nestNeuralNet_tau import nestNet
import math
import pickleData
...
def run(task_id, params=None):
    ...
    if load:
        ...
        learning_rate = 0.075  # + 0.0009*np.exp(-np.arange(0, hmEpochs, 1) / 300)
...
# all_tau_s = [3.0, 5.0, 8.0, 10.0, 12.0, 15.0]
all_tau_s = [20.0, 30.0]
...
# filename = 'rate_0.175_' + 'testy_tau_s'
